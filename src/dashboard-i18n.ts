...
const fr: DashboardTranslations = {
  ...
  seoView: {
    ...
    buildingAudit: 'Génération de l\'audit SEO en cours… (calculé en arrière-plan pour ne pas surcharger le serveur, cela peut prendre un moment sur un gros site)',
    buildTimeout: 'La génération de l\'audit prend plus de temps que prévu. Réessayez dans quelques instants.',
    runAudit: 'Lancer l\'audit du site',
    auditNotRun: 'L\'audit analyse toutes vos pages et articles. Il s\'exécute en arrière-plan (throttlé pour ne pas ralentir le site) — lancez-le quand vous le souhaitez.',
    ...
    bulkOptimizeMeta: 'Optimiser méta (IA)',
    bulkOptimizing: 'Analyse…',
    bulkConfirm: 'Confirmer ?',
    optimizeSite: 'Optimiser le site',
    optimizeSiteHint: 'Cible automatiquement les pages à problème (méta manquante, sans mot-clé, score faible) → aperçu → appliquer',
    bulkPreviewTitle: 'Corrections méta proposées',
    bulkApply: 'Appliquer',
    bulkApplying: 'Application…',
    bulkCancel: 'Annuler',
    bulkExport: 'Exporter CSV',
    bulkNoChanges: 'Aucune correction nécessaire sur la sélection.',
    bulkCappedNote: 'limite atteinte (affine la sélection)',
    bulkAppliedNote: '✓ Corrections appliquées. Rafraîchis pour recalculer les scores (une seule fois, après tes lots).',
  ...
  schemaBuilder: {
    ...
    knowsAbout: 'Sujets d’expertise (autorité topique, séparés par des virgules)',
    ...
    title: 'Titre',
    author: 'Auteur',
    authorSameAs: 'Profils de l’auteur (sameAs : Wikidata/LinkedIn/ORCID, séparés par des virgules)',
    publisher: 'Éditeur',
    imageUrl: 'URL image',
  ...
  seoAnalyzer: {
    ...
    seoScore: 'Score SEO',
    aiReadiness: 'IA',
    aiReadinessTooltip: "Prêt pour l'IA — qualité de structuration pour être cité par les moteurs génératifs (AI Overviews, ChatGPT, Perplexity). Distinct du score SEO.",
    outOf100: '/ 100',
    ...
    optimizeIntro: 'L\'IA analyse la page et propose des meta optimisées (titre, description, mot-clé). Vérifiez puis appliquez.',
    optimizeRunning: 'Analyse en cours…',
    applyAll: 'Appliquer',
    applied: 'Appliqué',
    whyChanges: 'Pourquoi ces changements',
    labelCurrent: 'Actuel',
    labelSuggested: 'Suggéré',
    labelFocusKeyword: 'Mot-clé cible',
    heuristicNote: 'Suggestions heuristiques (clé API Claude non configurée).',
    applySaveHint: 'Champs remplis — pensez à enregistrer le document.',
    noMetaChange: 'Aucun changement proposé.',
  },
  scoreHistory: {
...
const en: DashboardTranslations = {
  ...
  seoView: {
    ...
    runAudit: 'Run site audit',
    auditNotRun: 'The audit analyzes all your pages and posts. It runs in the background (throttled so it won\'t slow the site down) — start it whenever you like.',
  ...
  schemaBuilder: {
    ...
    knowsAbout: 'Areas of expertise (topical authority, comma-separated)',
    ...
    title: 'Title',
    author: 'Author',
    authorSameAs: 'Author profiles (sameAs: Wikidata/LinkedIn/ORCID, comma-separated)',
    publisher: 'Publisher',
    imageUrl: 'Image URL',
