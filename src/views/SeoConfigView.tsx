...
import { SeoConfigViewClient } from './SeoConfigViewClient.js'
import { ViewErrorBoundary } from './ErrorBoundaryClient.js'
import { seoViewRedirectTarget } from '../helpers/viewAccess.js'

export const SeoConfigView: React.FC<AdminViewServerProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <ViewErrorBoundary viewName="SeoConfigView">
        <SeoConfigViewClient />
      </ViewErrorBoundary>
    </DefaultTemplate>
  )
