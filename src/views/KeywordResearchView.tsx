...
import { KeywordResearchViewClient } from './KeywordResearchViewClient.js'
import { ViewErrorBoundary } from './ErrorBoundaryClient.js'
import { seoViewRedirectTarget } from '../helpers/viewAccess.js'

export const KeywordResearchView: React.FC<AdminViewServerProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <ViewErrorBoundary viewName="KeywordResearchView">
        <KeywordResearchViewClient />
      </ViewErrorBoundary>
    </DefaultTemplate>
  )
}
